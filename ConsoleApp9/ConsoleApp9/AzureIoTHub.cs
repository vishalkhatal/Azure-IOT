...
class AzureIoTHub
{
    ...
    //
    const string deviceConnectionString = "HostName=IOTKMSDEMO.azure-devices.net;DeviceId=MyDotnetDevice;SharedAccessKey=/+iV5k6Vn+Hz/eIRbwXHFHIru3+0Tmj/s/8cbnvk5x4=";
    
    //
    // To monitor messages sent to device "kraaa" use iothub-explorer as follows:
    //    iothub-explorer monitor-events --login HostName=IOTKMSDEMO.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=58NszU+8DnBwmtQgTaWQ9iYCLZL4y4cKog8ZcvbAX20= "MyDotnetDevice"
    //
    ...
    public static async Task SendDeviceToCloudMessageAsync()
    {
        CreateClient();
#if WINDOWS_UWP
        var str = "{\"deviceId\":\"MyDotnetDevice\",\"messageId\":1,\"text\":\"Hello, Cloud from a UWP C# app!\"}";
#else
        var str = "{\"deviceId\":\"MyDotnetDevice\",\"messageId\":1,\"text\":\"Hello, Cloud from a C# app!\"}";
#endif
